...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<GtEfxaag>(entity =>
            {
                ...
                entity.Property(e => e.AdaccountCode)
                    .HasColumnName("ADAccountCode")
                    .HasMaxLength(15)
                    .IsUnicode(false);
                ...
                entity.Property(e => e.DpaccountCode)
                    .HasColumnName("DPAccountCode")
                    .HasMaxLength(15)
                    .IsUnicode(false);

                entity.Property(e => e.FaaccountCode)
                    .HasColumnName("FAAccountCode")
                    .HasMaxLength(15)
                    .IsUnicode(false);
            ...
            {
                entity.HasKey(e => new { e.Isdcode, e.AssetGroupId, e.AssetSubGroupId, e.DepreciationMethod, e.EffectiveFrom })
                    .HasName("PK_GT_EFXADM_1");
