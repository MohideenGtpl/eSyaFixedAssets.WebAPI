...
{
    public partial class GtEfxarh
    {
        public GtEfxarh()
        {
            GtEfxard = new HashSet<GtEfxard>();
        }
        ...
        public bool IsInstallationApplicable { get; set; }
        ...
        public virtual ICollection<GtEfxard> GtEfxard { get; set; }
    }
}
